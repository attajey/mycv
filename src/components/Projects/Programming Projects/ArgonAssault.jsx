        ...
        <div className="row">
          ...
          <div className="col-12 pb-5">
            ...
            <p className="p-project-indiv">
              ...
              some new enemies. As you can see it's not a piece of art...
              <br />
              I also want to add some extra features, such as fuel, bonus
              points, and some other cool stuff, to the game.
              <br />
